...
class VHDLTestbenchDefaultDialog(QDialog):
    ...
    def __init__(self, add_or_edit, data=None):
        ...
        self.setWindowTitle("ChatGPT VHDL Testbench Default Command")
        title_font = QFont()
