...
class VerilogModelDefaultDialog(QDialog):
    ...
    def __init__(self, add_or_edit, data=None):
        ...
        self.setWindowTitle("ChatGPT Verilog Model Default Command")
        title_font = QFont()
