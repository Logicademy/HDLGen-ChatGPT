...
class VerilogHeaderDefaultDialog(QDialog):

    def __init__(self, add_or_edit, data=None):
        super().__init__()

        self.setWindowTitle("ChatGPT Verilog Header Default Command")
        title_font = QFont()
