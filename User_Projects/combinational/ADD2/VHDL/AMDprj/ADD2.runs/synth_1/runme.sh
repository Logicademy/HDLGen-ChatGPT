...
HD_PWD='C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/ADD2/VHDL/AMDprj/ADD2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADD2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADD2.tcl
