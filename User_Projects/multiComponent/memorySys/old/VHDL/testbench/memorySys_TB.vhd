...
-- manually added code START
	testNo <= 1; -- write all 5 bank 0 registers. values 0-15
	selMemBankToBeWritten <= '0';
	selMemBankToBeRead <= '0';
	ce <= '1';
    we <= '1';
	for i in 0 to 3 loop
	  ...
	  for j in 0 to 15 loop
	    dIn <= std_logic_vector( to_unsigned(j, 4) );
    	wait for period;
	  end loop;
	end loop;

	testNo <= 2; -- write all 5 bank 1 registers. values 1-15, 0
	selMemBankToBeWritten <= '1';
	selMemBankToBeRead <= '0';
	ce <= '1';
    we <= '1';
	for i in 0 to 3 loop 
	  add <= std_logic_vector( to_unsigned(i, 2) );
	  for j in 0 to 15 loop
	    dIn <= std_logic_vector( to_unsigned(j, 4) + 1 );
    	wait for period;
	  end loop;
	end loop;

	testNo <= 3; -- read bank 0
	selMemBankToBeWritten <= '0';
	selMemBankToBeRead <= '0';
	ce <= '0';
    we <= '0';
	...
	testNo <= 4; -- read bank 1
	selMemBankToBeWritten <= '0';
	selMemBankToBeRead <= '1';
	ce <= '0';
    we <= '0';
	for i in 0 to 3 loop
	  add <= std_logic_vector( to_unsigned(i, 2) );
