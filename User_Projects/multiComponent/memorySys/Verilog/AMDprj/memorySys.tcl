        ...
        # $vivado_bat_path -source C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/multiComponent/memorySys/Verilog/AMDPrj/memorySys.tcl 
        ...
        create_project  memorySys  ./Verilog/AMDprj -part xc7z020clg400-1 -force

        set_property target_language Verilog [current_project]

        add_files -norecurse  ./Verilog/model/memorySys.v
...
add_files -norecurse  C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/combinational/mux21_4/VHDL/model/mux21_4.vhd 
        ...
        add_files -fileset sim_1 -norecurse ./Verilog/testbench/memorySys_TB.v
        ...
        add_files -fileset sim_1 -norecurse ./Verilog/AMDPrj/memorySys_TB_behav.wcfg

        # save_wave_config {./Verilog/AMDprj/memorySys_TB_behav.wcfg}
