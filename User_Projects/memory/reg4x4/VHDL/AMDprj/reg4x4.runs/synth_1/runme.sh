...
HD_PWD='C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/memory/reg4x4/VHDL/AMDprj/reg4x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg4x4.tcl
