        ...
        # cd {C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/memory/reg4x4} 

        # $vivado_bat_path -source C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/memory/reg4x4/VHDL/AMDPrj/reg4x4.tcl 
        ...
        create_project  reg4x4  ./VHDL/AMDprj -part xc7z020clg400-1 -force

        set_property target_language VHDL [current_project]

        add_files -norecurse  ./VHDL/model/reg4x4.vhd
        ...
        add_files -fileset sim_1 -norecurse ./VHDL/testbench/reg4x4_TB.vhd
        ...
        add_files -fileset sim_1 -norecurse ./VHDL/AMDPrj/reg4x4_TB_behav.wcfg

        # save_wave_config {./VHDL/AMDprj/reg4x4_TB_behav.wcfg}
