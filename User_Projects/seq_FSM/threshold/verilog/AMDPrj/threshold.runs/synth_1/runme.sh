...
HD_PWD='C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/seq_FSM/threshold/verilog/AMDPrj/threshold.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log threshold.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source threshold.tcl
