...
HD_PWD='C:/2023/vicilogic/HDLGenTop/HDLGen/User_Projects/seq_FSM/singleShot/verilog/AMDPrj/singleShot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singleShot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleShot.tcl
